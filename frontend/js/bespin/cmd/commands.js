...
bespin.cmd.commands.add({
    name: 'cmdloadset',
    takes: ['commandset'],
    preview: 'load up a new set of commands that live in bespin.cmd.[name of commandset]',
    execute: function(self, commandset) {
        if (!commandset) commandset = "debugcommands"; // default to debug commands
        dojo.require("bespin.cmd." + commandset);
    }
});
...
// -- Collaboration commands (TODO: place in collaborationcommands.js)
